...
`docs/superpowers/plans/2026-07-04-ra-pwa-relay-payload-trust-decision.md`다. Relay/M2는
...
기록한다. 다음 로컬 작업은 Hosted observability and retention policy evidence다.
