...
| Windows GUI `ai-terminal.exe` | [x] | 독립 Tauri/xterm GUI, bundled `ash.exe` PTY bridge, terminal UX, AI/safety/storage/audit, portable/NSIS smoke evidence green, v0.3.3 release body 보강, release follow-up preflight | MSI 검토와 수동 더블클릭 smoke는 후속 |
