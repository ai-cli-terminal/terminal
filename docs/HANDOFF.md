...
`docs/superpowers/plans/2026-07-04-ra-pwa-relay-observability-retention-evidence.md`다. Relay/M2는
...
기록하고, aggregate-only observability/retention evidence도 닫았다. 다음 로컬
작업은 Hosted failure-mode evidence다.
