...
최신 Relay runtime 작업 문서는
`docs/superpowers/plans/2026-07-04-ra-pwa-relay-daemon-runtime-loop.md`다. Relay/M2는
...
runtime loop 결선까지 닫았다. 다음 로컬 작업은 PWA Relay tab 기반 approve/reject
browser/operator evidence를 추가하는 것이다.
