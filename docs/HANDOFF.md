...
`docs/superpowers/plans/2026-07-04-ra-pwa-relay-managed-public-verifier-key-registry-runtime-smoke.md`다. Relay/M2는
...
완료됐지만 implementationCanStart=false다. explicit self-hosted relay readiness는
green이며 다음 로컬 작업은 Managed relay revocation and rotation propagation smoke다.
