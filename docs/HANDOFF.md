...
`docs/superpowers/plans/2026-07-04-ra-pwa-relay-managed-tenant-session-registration-quota-smoke.md`다. Relay/M2는
...
다음 로컬 작업은 Managed relay active session and byte quota smoke다.
