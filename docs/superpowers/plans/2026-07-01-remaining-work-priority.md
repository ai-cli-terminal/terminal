...
|---|---|---|---|
| P1 local | Self-hosted relay deployment runbook | Hosted/self-hosted relay 운영 절차, ticket registration, reconnect, observability, failure-mode evidence를 문서화 | Relay는 이 증거 전까지 product default나 일반 user-selectable transport가 아님 |
