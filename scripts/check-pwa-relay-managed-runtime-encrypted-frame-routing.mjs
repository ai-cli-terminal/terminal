...
assert.equal(controlPlaneWiringSummary.nextLocalSlice, "managed-relay-runtime-quota-and-metering-integration");
...
assert.equal(routingSummary.nextLocalSlice, "managed-relay-runtime-quota-and-metering-integration");
assert.ok(
