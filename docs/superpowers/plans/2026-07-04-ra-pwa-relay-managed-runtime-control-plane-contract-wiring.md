...
Follow-up status: Managed relay runtime encrypted frame routing and
quota/metering integration are now complete. Current next slice is managed
relay runtime support and abuse operations integration:
