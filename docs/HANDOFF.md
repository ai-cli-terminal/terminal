...
`docs/superpowers/plans/2026-07-04-ra-pwa-relay-managed-revocation-and-rotation-propagation-smoke.md`다. Relay/M2는
...
완료됐고 revocation/rotation propagation smoke도 닫혔지만
implementationCanStart=false다. explicit self-hosted relay readiness는 green이며
다음 로컬 작업은 Managed relay tenant session registration quota smoke다.
