...
assert.equal(review.nextLocalSlice, "managed-relay-active-session-and-byte-quota-smoke");
...
assert.ok(review.remainingRuntimeEvidence.includes("active-session-and-byte-quota-smoke"));
