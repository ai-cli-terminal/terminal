...
- No signed/HMAC relay tickets yet.
...
1. Add signed/HMAC relay tickets generated by a daemon-side prototype.
2. Add relay session rotation and reconnect evidence.
