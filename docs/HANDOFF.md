...
최신 Relay evidence 작업 문서는
`docs/superpowers/plans/2026-07-04-ra-pwa-relay-approve-reject-evidence.md`다. Relay/M2는
...
닫았다. 다음 로컬 작업은 self-hosted relay deployment runbook이다.
