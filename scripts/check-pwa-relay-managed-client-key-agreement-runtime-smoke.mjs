...
assert.equal(smoke.nextLocalSlice, "managed-relay-revocation-and-rotation-propagation-smoke");
...
assert.ok(smoke.remainingRuntimeEvidence.includes("revocation-and-rotation-propagation-smoke"));
