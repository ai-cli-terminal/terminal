...
`docs/superpowers/plans/2026-07-04-ra-pwa-relay-production-service-artifact.md`다. Relay/M2는
...
daemon `remote,tls` WSS runtime readiness를 분리해 기록한다. 다음 로컬 작업은
Verifier-key distribution or public-key ticket signing이다.
