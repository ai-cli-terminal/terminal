...
`docs/superpowers/plans/2026-07-04-ra-pwa-relay-hosted-wss-readiness-gate.md`다. Relay/M2는
...
daemon `wss://` runtime blocker를 분리해 기록한다. 다음 로컬 작업은 Daemon WSS relay
runtime support다.
